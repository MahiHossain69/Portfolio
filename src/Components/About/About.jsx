...
function About() {
  ...
  <section  id='about' className='mt-[100px]'>
    ...
    <div className=" h-[1px] bg-[#fff] border-b border-white border-b-1 mb-[3.2rem] relative">
          <h3 className='bg-black absolute top-[-17px] left-[50%] ml-[-165px] w-[325px] text-center block text-[#ffffff] text-[1.4rem] font-normal p-0'>ABOUT ME</h3>
        ...
        <div className=" text-white font-play leading-[40px] text-center">
            <p>Hi there! I'm Mahi Hossain Chad, a passionate Frontend Developer with a keen eye for detail and a love for creating beautiful, user-friendly web experiences. I specialize in building responsive, interactive websites using the latest technologies like HTML5, CSS3, JavaScript, React, and more.
